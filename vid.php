...
if (isset($_GET['vidid'])) {
    ...
    $vidid = htmlspecialchars($username, ENT_QUOTES, 'UTF-8');
...
?>
    ...
    <br />
        ...
        <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@<?php echo $username; >/video/<?php echo $vidid; >" data-video-id="<?php echo $vidid; >" style="max-width: 605px;min-width: 325px;" > 
        	...
        	<section> 
        		<a target="_blank" title="@shortfilm.mp4" href="https://www.tiktok.com/@<?php echo $username; >?refer=embed">@<?php echo $username; ></a> Never judge a book by its cover part 1 
